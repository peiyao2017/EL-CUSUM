...
ks_cusum=function(threshold=100,d=4,m=100,v0=list(c(-1.5,1,0.9),c(1.5,1,-0.9)),v1=list(c(-2,1,0.9),c(2,1,-0.9))){
  mu1=rep(0.5,d)
  c=0
  y0=matrix(0,m,d)
  y1=matrix(0,m,d)
...
ks1_cusum=function(m=100,d=4,threshold=100,v0=list(c(-1.5,1,0.9),c(1.5,1,-0.9)),v1=list(c(-2,1,0.9),c(2,1,-0.9))){
  false=0
  c=0
  y0=matrix(0,m,d)
  y1=matrix(0,m,d)
