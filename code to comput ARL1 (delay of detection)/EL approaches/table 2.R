...
ael1_laplace=function(m=20,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
...
ael1_mean=function(m=20,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
...
el1_mean=function(m=20,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
  x1=mvrnorm(n = m, mu=mu1, Sigma=diag(1,d,d))
  x5=colMeans(x)
...
tael1_laplace=function(m=20,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
  x1=matrix(0,ncol=1,nrow=m)
  x2=matrix(0,ncol=1,nrow=m)
...
tael1_mean=function(m=20,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
  x1=mvrnorm(n = m, mu=mu1, Sigma=diag(1,d,d))
  x5=colMeans(x)
...
tel1_mean=function(m=20,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
  x1=mvrnorm(n = m, mu=mu1, Sigma=diag(1,d,d))
  x5=colMeans(x)
...
tel1_laplace=function(m=20,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
  x1=matrix(0,ncol=1,nrow=m)
  x2=matrix(0,ncol=1,nrow=m)
