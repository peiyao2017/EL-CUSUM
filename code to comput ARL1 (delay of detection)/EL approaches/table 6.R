...
ael_laplace=function(threshold=0.39, m=20,d=2,v0=list(c(-1.5,1,0.9),c(1.5,1,-0.9)),v1=list(c(-2,1,0.9),c(2,1,-0.9))){
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v0)
  }
  ...
  for(i in 1:m){
    x71[i,]=rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v1)
  }
  for(i in 1:m){
  ...
  if(c<=100){
    ...
    h1=matrix(0,c,2)
    for(i in 1:c){
      x9[i,]=rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v0)
    }
    for(i in 1:c){
    ...
    repeat{
      ...
      x9=rbind(x9,rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v0))
      c=c+1
      print(c)
...
ael1_var=function(m=20,d=4,threshold=400,v0=list(c(-1.5,1,0.9),c(1.5,1,-0.9)),v1=list(c(-2,1,0.9),c(2,1,-0.9))){
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v0)
  }
  ...
  for(i in 1:m){
    x7[i,]=rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v1)
  }
  x81=colMeans(x7)
  ...
  nodetect=0
  repeat{
    x9=rbind(x9,rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v1))
    h0=rbind(h0,(x9[c,]-x51)^2-x5)
    h1=rbind(h1,(x9[c,]-x81)^2-x8)
    z=numeric()
    for(i in 1:(c-(d-1))){
...
el1_laplace=function(m=20,d=4,threshold=4.1,v0=list(c(-1.5,1,0.9),c(1.5,1,-0.9)),v1=list(c(-2,1,0.9),c(2,1,-0.9))){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v0)
...
el1_var=function(m=20,d=4,threshold=400,v0=list(c(-1.5,1,0.9),c(1.5,1,-0.9)),v1=list(c(-2,1,0.9),c(2,1,-0.9))){
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v0)
  }
...
tael1_var=function(m=20,d=4,threshold=400,v0=list(c(-1.5,1,0.9),c(1.5,1,-0.9)),v1=list(c(-2,1,0.9),c(2,1,-0.9))){
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v0)
  }
...
tel1_laplace=function(m=20,d=4,threshold=400,v0=list(c(-1.5,1,0.9),c(1.5,1,-0.9)),v1=list(c(-2,1,0.9),c(2,1,-0.9))){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v0)
...
tel1_var=function(m=20,d=4,threshold=400,v0=list(c(-1.5,1,0.9),c(1.5,1,-0.9)),v1=list(c(-2,1,0.9),c(2,1,-0.9))){
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v0)
  }
...
tael1_laplace=function(m=20,d=2,threshold=0.39,v0=list(c(-1.5,1,0.9),c(1.5,1,-0.9)),v1=list(c(-2,1,0.9),c(2,1,-0.9))){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rmix(n=d,pii=c(0.5,0.5),family = "Skew.normal",arg = v0)
