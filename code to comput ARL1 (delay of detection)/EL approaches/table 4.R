...
ael1_laplace=function(m=20,d=2,threshold=200){
  false=0
...
ael1_var=function(m=20,d=2,mu1=rep(0.5,times=d),threshold=200){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=10,rate=2)
...
el1_laplace=function(m=20,d=2,threshold=2.1){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=10,rate=2)
...
el1_var=function(m=20,d=2,threshold=200){
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=10,rate=2)
  }
...
tael1_laplace=function(m=20,d=2,mu1=rep(0.5,times=d),threshold=200){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=10,rate=2)
...
tael1_var=function(m=20,d=2,threshold=200){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=10,rate=2)
...
tel1_laplace=function(m=20,d=2,mu1=rep(0.5,times=d),threshold=200){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=10,rate=2)
...
tel1_var=function(m=20,d=2,threshold=200){
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=10,rate=2)
  }
