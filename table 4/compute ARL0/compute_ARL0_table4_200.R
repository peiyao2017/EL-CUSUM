...
threshold_app=7.2
threshold_ks=9
threshold_el_var=11.8
threshold_el_laplace=11
threshold_ael_var=2.3 
threshold_ael_laplace=2.1
threshold_tel_var=5.9
threshold_tel_laplace=5 
threshold_tael_var=1.59 
...
results=foreach (i = 1:repetition, .combine='c', .multicombine=FALSE) %dopar% {
  ...
  obs2=matrix(rgamma(n=d*(maxobs-49),shape = 10,rate =2),nrow=maxobs-49,ncol=d)
  obs=rbind(obs1,obs2)
...
save(ARL0,file = "ARL0_Table4_200.RData")