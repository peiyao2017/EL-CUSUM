...
threshold_el_var=seq(from=30,to=40,by=1)

threshold_el_laplace=seq(from=30,to=40,by=1)

threshold_ael_var=seq(from=4,to=5,by=0.1)
...
threshold_tael_laplace=seq(from=3,to=4,by=0.1)
...
save(FAP,file = "FAP_Table7_100.RData")