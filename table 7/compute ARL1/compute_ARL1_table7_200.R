...
threshold_ael_var=3.9
threshold_ael_laplace=6.1
threshold_tel_var=15 
threshold_tel_laplace=22
threshold_tael_var=2.4
threshold_tael_laplace=3 
...
save(ARL1,file = "ARL1_Table7_200.RData")