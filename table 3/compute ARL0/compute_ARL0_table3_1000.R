...
threshold_el_laplace=56

threshold_ael_mean=3.3

threshold_ael_laplace=7

threshold_tel_mean=9.7

threshold_tel_laplace=23

threshold_tael_mean=2.2 

threshold_tael_laplace=3.2
...
save(ARL0,file = "ARL0_Table3_1000.RData")