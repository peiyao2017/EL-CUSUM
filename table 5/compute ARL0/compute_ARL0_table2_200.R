...
threshold_ael_mean=3.5
threshold_ael_laplace=4.1
threshold_tel_mean=12
threshold_tel_laplace=12
threshold_tael_mean=2
...
obs2=matrix(rnorm(n=(maxobs-49)*d,mean=mu0,sd=Sigma),nrow=maxobs-49,ncol=d)
obs=rbind(obs1,obs2)
...
save(ARL0,file = "ARL0_Table2_200.RData")