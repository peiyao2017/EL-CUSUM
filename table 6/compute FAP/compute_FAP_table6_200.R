...
threshold_ael_var=seq(from=1,to=2,by=0.1)

threshold_ael_laplace=seq(from=2,to=3 ,by=0.1)

threshold_tel_var=0

threshold_tel_laplace=seq(from=4,to=5,by=0.1)

threshold_tael_var=seq(from=0,to=1,by=0.1)
...
save(FAP,file = "FAP_Table6_200.RData")