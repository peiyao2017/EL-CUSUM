...
threshold_ks=27 
threshold_el_var=13
threshold_el_laplace=9
threshold_ael_var=1.1 
threshold_ael_laplace=2.5
threshold_tel_var=7
threshold_tel_laplace=4.6
threshold_tael_var=0.5
threshold_tael_laplace=1.7 
...
save(ARL0,file = "ARL0_Table6_200.RData")